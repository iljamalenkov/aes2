...
""
 ...
 "<button name='b' value='1'>A ON</button>"
 "<button name='b' value='0'>A OFF</button><BR>"
 "<button name='c' value='1'>A ON</button>"
 "<button name='c' value='0'>A OFF</button><BR>"
 "<button name='d' value='1'>A ON</button>"
 "<button name='d' value='0'>A OFF</button><BR>"
 "<button name='e' value='1'>A ON</button>"
 "<button name='e' value='0'>A OFF</button><BR>"
 "<button name='f' value='1'>A ON</button>"
 "<button name='f' value='0'>A OFF</button><BR>"
 "<button name='g' value='1'>A ON</button>"
 "<button name='g' value='0'>A OFF</button><BR>"
 "<button name='h' value='1'>A ON</button>"
 "<button name='h' value='0'>A OFF</button><BR>"
  "</form><pre>";
